...
_Route-Level app.use() - Multiple Paths_
...
_Open-Source Middleware: Logging_
...
_Open-Source Middleware: Body Parsing_
...
If we look at our bodyParser(https://github.com/expressjs/body-parser#body-parser), we see a simplified version of how one might perform request body parsing. Let’s see if there’s a better way that doesn’t involve us trying to create our own body-parser. Maybe we can find a library that does it for us?
...
_Discovering Open-Source Middleware_
